---
title: "Which Indoor Plant Goes in Which Room — A Guide by Light"
description: "Fiddle leaf fig, monstera, snake plant, pothos and more matched to the right room by light level and humidity. Stop killing plants by putting them in the wrong spot."
pubDate: "2026-05-28"
author: "Avinovo"
...
<div style="margin: 2rem 0; border: 1px solid #C0D4A8; background: #C0D4A8; display: grid; grid-template-columns: repeat(auto-fit, minmax(min(170px, 100%), 1fr)); gap: 1px; overflow: hidden;">
  <div style="background: #FDF8E8; padding: 1rem 0.875rem;">
    <div style="width: 10px; height: 10px; background: #E8B84B; border-radius: 50%; margin-bottom: 0.6rem;"></div>
    <div style="font-size: 0.65rem; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; color: #8B6014; margin-bottom: 0.4rem;">Bright Direct</div>
    <div style="font-size: 0.8rem; color: #5A4010; line-height: 1.55;">Sun hits the plant directly for several hours daily. South-facing windowsill in summer. Cacti, succulents, herbs.</div>
  </div>
  <div style="background: #F2F9E8; padding: 1rem 0.875rem;">
    <div style="width: 10px; height: 10px; background: #8EC44A; border-radius: 50%; margin-bottom: 0.6rem;"></div>
    <div style="font-size: 0.65rem; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; color: #3A6020; margin-bottom: 0.4rem;">Bright Indirect</div>
    <div style="font-size: 0.8rem; color: #2E4A1E; line-height: 1.55;">Well-lit room, no direct sun on plant. 1–2 metres from a south or west window. The sweet spot for most tropical plants.</div>
  </div>
  <div style="background: #EAF2DC; padding: 1rem 0.875rem;">
    <div style="width: 10px; height: 10px; background: #5A8A35; border-radius: 50%; margin-bottom: 0.6rem;"></div>
    <div style="font-size: 0.65rem; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; color: #2E5020; margin-bottom: 0.4rem;">Medium</div>
    <div style="font-size: 0.8rem; color: #2E4A1E; line-height: 1.55;">Natural daylight, no direct sun at any point. Central room positions, beside a north-facing window. Growth is slower but stable.</div>
  </div>
  <div style="background: #E0EAD0; padding: 1rem 0.875rem;">
    <div style="width: 10px; height: 10px; background: #2E5020; border-radius: 50%; margin-bottom: 0.6rem;"></div>
    <div style="font-size: 0.65rem; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; color: #1A3010; margin-bottom: 0.4rem;">Low</div>
    <div style="font-size: 0.8rem; color: #2E4A1E; line-height: 1.55;">Minimal daylight — dark hallways, rooms with small or obstructed windows. Plants here survive rather than thrive. Choices are limited.</div>
  </div>
</div>
...
![Your living room with a large fiddle leaf fig beside a bright window, natural light, warm interior](/images/indoor-plants/living-room.jpg)

<div style="display: flex; align-items: center; gap: 1rem; margin: 0 0 2rem; padding: 0.75rem 1rem; background: #F2F7EC; border-left: 3px solid #8EC44A; flex-wrap: wrap;">
  <div>
    <div style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; color: #5A8A35; margin-bottom: 0.2rem;">Typical light</div>
    <div style="font-size: 0.875rem; color: #1E3012; font-weight: 500;">Bright to medium indirect</div>
  </div>
  <div style="margin-left: auto;">
    <div style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; color: #5A8A35; margin-bottom: 0.2rem;">Plants covered</div>
    <div style="font-size: 0.875rem; color: #1E3012; font-weight: 500;">4 varieties</div>
  </div>
</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Fiddle Leaf Fig</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Ficus lyrata</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #DFF0C0; color: #2E5A10; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Bright indirect</span>
</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Monstera</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Monstera deliciosa</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #E4F0D0; color: #2A5018; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Medium to bright indirect</span>
</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Bird of Paradise</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Strelitzia nicolai</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #DFF0C0; color: #2E5A10; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Bright indirect</span>
</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Rubber Plant</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Ficus elastica</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #E4F0D0; color: #2A5018; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Medium to bright indirect</span>
</div>
...
![Your bedroom with a snake plant and trailing pothos on a high shelf in soft natural light](/images/indoor-plants/bedroom.jpg)

<div style="display: flex; align-items: center; gap: 1rem; margin: 0 0 2rem; padding: 0.75rem 1rem; background: #F2F7EC; border-left: 3px solid #5A8A35; flex-wrap: wrap;">
  <div>
    <div style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; color: #5A8A35; margin-bottom: 0.2rem;">Typical light</div>
    <div style="font-size: 0.875rem; color: #1E3012; font-weight: 500;">Low to medium indirect</div>
  </div>
  <div style="margin-left: auto;">
    <div style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; color: #5A8A35; margin-bottom: 0.2rem;">Plants covered</div>
    <div style="font-size: 0.875rem; color: #1E3012; font-weight: 500;">4 varieties</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Snake Plant</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Dracaena trifasciata</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #D0E8B8; color: #1E4010; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Low to medium</span>
</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Peace Lily</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Spathiphyllum</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #D0E8B8; color: #1E4010; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Low to medium</span>
</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Pothos</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Epipremnum aureum</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #D0E8B8; color: #1E4010; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Low to medium</span>
</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Calathea / Prayer Plant</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Calathea orbifolia, Maranta leuconeura</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #E4F0D0; color: #2A5018; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Medium indirect</span>
</div>
...
![Your bathroom with a lush boston fern hanging beside a frosted window, steam and green](/images/indoor-plants/bathroom.jpg)

<div style="display: flex; align-items: center; gap: 1rem; margin: 0 0 2rem; padding: 0.75rem 1rem; background: #F2F7EC; border-left: 3px solid #5A8A35; flex-wrap: wrap;">
  <div>
    <div style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; color: #5A8A35; margin-bottom: 0.2rem;">Typical light</div>
    <div style="font-size: 0.875rem; color: #1E3012; font-weight: 500;">Low to medium, high humidity</div>
  </div>
  <div style="margin-left: auto;">
    <div style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; color: #5A8A35; margin-bottom: 0.2rem;">Plants covered</div>
    <div style="font-size: 0.875rem; color: #1E3012; font-weight: 500;">4 varieties</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Boston Fern</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Nephrolepis exaltata</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #E4F0D0; color: #2A5018; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Medium indirect</span>
</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Spider Plant</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Chlorophytum comosum</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #D0E8B8; color: #1E4010; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Low to medium</span>
</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Aloe Vera</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Aloe barbadensis</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #FDF8E8; color: #8B6014; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Bright direct or indirect</span>
</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">ZZ Plant</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Zamioculcas zamiifolia</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #D0E8B8; color: #1E4010; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Low to medium</span>
</div>
...
<div style="display: flex; align-items: center; gap: 1rem; margin: 0 0 2rem; padding: 0.75rem 1rem; background: #F2F7EC; border-left: 3px solid #8EC44A; flex-wrap: wrap;">
  <div>
    <div style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; color: #5A8A35; margin-bottom: 0.2rem;">Typical light</div>
    <div style="font-size: 0.875rem; color: #1E3012; font-weight: 500;">Bright — best windowsills in the house</div>
  </div>
  <div style="margin-left: auto;">
    <div style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; color: #5A8A35; margin-bottom: 0.2rem;">Plants covered</div>
    <div style="font-size: 0.875rem; color: #1E3012; font-weight: 500;">3 varieties</div>
  </div>
</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Herbs</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Basil, Rosemary, Thyme, Mint</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #FDF8E8; color: #8B6014; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Bright direct or indirect</span>
</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Pothos</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Epipremnum aureum</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #E4F0D0; color: #2A5018; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Medium</span>
</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Chinese Money Plant</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Pilea peperomioides</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #DFF0C0; color: #2E5A10; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Bright indirect</span>
</div>
...
<div style="display: flex; align-items: center; gap: 1rem; margin: 0 0 2rem; padding: 0.75rem 1rem; background: #F2F7EC; border-left: 3px solid #2E5020; flex-wrap: wrap;">
  <div>
    <div style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; color: #5A8A35; margin-bottom: 0.2rem;">Typical light</div>
    <div style="font-size: 0.875rem; color: #1E3012; font-weight: 500;">Low — most challenging in the home</div>
  </div>
  <div style="margin-left: auto;">
    <div style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; color: #5A8A35; margin-bottom: 0.2rem;">Plants covered</div>
    <div style="font-size: 0.875rem; color: #1E3012; font-weight: 500;">3 varieties</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Cast Iron Plant</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Aspidistra elatior</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #C8E0A8; color: #1A3A08; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Very low</span>
</div>
...
<div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 0.5rem; margin: 2rem 0 0.75rem; padding-bottom: 0.6rem; border-bottom: 1px solid #C0D4A8;">
  <span style="font-size: 1rem; font-weight: 600; color: #1E3012;">Snake Plant</span>
  <span style="font-size: 0.8rem; color: #8B9E7A; font-style: italic;">Dracaena trifasciata</span>
  <span style="font-size: 0.6rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; background: #C8E0A8; color: #1A3A08; padding: 0.2rem 0.6rem; margin-left: auto; white-space: nowrap;">Low</span>
</div>
